...
starts. The devcontainer MUST expose every port the app and any local Supabase stack use to the host via
...
**Version**: 1.6.1 | **Ratified**: 2026-09-15 | **Last Amended**: 2026-09-16
